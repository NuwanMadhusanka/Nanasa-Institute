...
export default function InstructorVideo({ navigation }) {
    ...
    const videoAdd = () => {
        ...
        navigation.navigate('InstructorVideosAdd', data);
    };
                                        ...
                                        <View>
                                            <TouchableOpacity>
                                                <Avatar
                                                    ...
                                                    size="large"
                                                    rounded
                                                    source={{ uri: 'https://firebasestorage.googleapis.com/v0/b/nanasa-project.appspot.com/o/video_download.png?alt=media&token=82d84955-4394-47cc-add4-b475d322fe26' }}
                                                />
                                            </TouchableOpacity>
                                        </View>
